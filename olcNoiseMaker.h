...
#include <Windows.h>  // Must be included before any C++ headers
...
public:
	static vector<string> Enumerate()
	{
		...
		for (int n = 0; n < nDeviceCount; n++)
			...
			{
				// Convert device name from CHAR[32] to std::string
				sDevices.push_back(string(woc.szPname));
			}
		return sDevices;
	}
